    ...
    if (TIM1_SRbits.UIF == 1)
    {
        ...
        */
        ...
        if (but_status[2] == PRES_DOW)
        {
            ...
            {
                flag_button_dim2 = 1;
                if (BUTTON_DIM_CHANNEL2 <= 3)
                {
                    BUTTON_DIM_CHANNEL2++;
                }
                if (BUTTON_DIM_CHANNEL2 >= 4)
                {
        ...
        if (but_status[7] == PRES_DOW)
        {
            ...
            {
                flag_button_dim1 = 1;
                if (BUTTON_DIM_CHANNEL1 <= 3)
                {
                    BUTTON_DIM_CHANNEL1++;
                }
                if (BUTTON_DIM_CHANNEL1 >= 4)
                {
...
RESET:
    ...
    */
    while (1)
    {
        ...
        if (flag_setdimmer2)
        {
            if (BUTTON_DIM_CHANNEL2 == 0)
            {
                set_value_dim(0, 2);
            }
            if (BUTTON_DIM_CHANNEL2 == 1)
            {
                set_value_dim(90, 2);
            }
            if (BUTTON_DIM_CHANNEL2 == 2)
            {
                set_value_dim(60, 2);
            }
            if (BUTTON_DIM_CHANNEL2 == 3)
        ...
        if (flag_setdimmer1)
        {
            if (BUTTON_DIM_CHANNEL1 == 0)
            {
                set_value_dim(0, 1);
            }
            if (BUTTON_DIM_CHANNEL1 == 1)
            {
                set_value_dim(90, 1);
            }
            if (BUTTON_DIM_CHANNEL1 == 2)
            {
                set_value_dim(60, 1);
            }
            if (BUTTON_DIM_CHANNEL1 == 3)
